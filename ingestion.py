...
embeddings = OpenAIEmbeddings(
    ...
    # how many text documents to embed at every request we make to openai (keep small to avoid rate limits)
    chunk_size=50,
...
async def main():
    ...
    tavily_crawl_results = tavily_crawl.invoke(
        input={
            ...
            "max_depth": 5,
            # "instructions": "content on ai agents" # these are natural language instructions for the crawler
        }
    )
